...
export const sendQuoteRequest = async (formData: QuoteRequestData): Promise<EmailResponse> => {
  try {
    ...
    const emailBody = encodeURIComponent(
      ...
      `Company Contact: +254 741 464497 | primeskyeastafrica@yahoo.com`
    );
    ...
    const successMessage = `Thank you ${formData.firstName}! Your quote request has been prepared. We'll contact you at ${formData.phone} within 24 hours.`;
    ...
    try {
      ...
      const templateParams = {
        to_email: 'primeskyeastafrica@yahoo.com',
        from_name: fullName,
